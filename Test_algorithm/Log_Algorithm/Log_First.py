...
def log_function(image: np.array, first_path: str,
...
if __name__ == "__main__":
    ...
    for group in name_groups:
        ...
        for i in range((len(images))):
            log_function(images[i], folder, res_folder, group[i])
            numb_group += 1
